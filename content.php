...
<div class="group">
    ...
    $subjects[1] = "Informática 1";
    $idsubjects[1] = "informatica1";

    $subjects[2] = "Informática 2";
    $idsubjects[2] = "informatica2";

    $subjects[3] = "Matemáticas 1";
    $idsubjects[3] = "matematicas1";
    ...
    */
    ...
    Actualizado: 2023-03-13 21:33:05</div>
    <!-- Cmd + Shift + I -->
